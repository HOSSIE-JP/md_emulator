...
function exportStagesHeader(projectDir, stages, assets = []) {
  ...
  stageList.forEach((stage, index) => {
    ...
    tableRows.push(`    { stage_${stageNo}_blocks, stage_${stageNo}_powerups, ${bgmPointer(stage.bgm_symbol)}, ${bgmLength(stage.bgm_symbol)}, ${imagePointer(stage.background_image_symbol)}, ${imagePointer(stage.clear_image_symbol)} }`);
  });
