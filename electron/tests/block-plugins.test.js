...
test('block-game-builder generator syncs the template and returns main source', () => {
  ...
  assert.match(result.sourceCode, /Generated by block-game-builder v0\.1\.0/);
...
test('block-stage-editor hooks create stages with incremented names and export headers', () => {
  ...
  assert.match(stagesHeader, /\{ stage_2_blocks, stage_2_powerups, bgm_stage2, sizeof\(bgm_stage2\), &image001, &image001 \}/);
