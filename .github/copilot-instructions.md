...
## PR・コードレビューコメント (MANDATORY)

- Pull Request の説明、レビューコメント、インラインコメントはすべて**日本語**で記述すること。
- GitHub Copilot が自動生成する PR タイトル・本文・レビュー指摘はすべて日本語で出力すること。
- 英語での出力が求められる場合を除き、AIによる生成テキストは日本語を使用すること。
